...
double distance = 0.;
double dot(Rot r1, Rot r2)   { return r1.getQ0()*r2.getQ0() + r1.getQ1()*r2.getQ1() + r1.getQ2()*r2.getQ2() + r1.getQ3()*r2.getQ3(); }
double angle(Rot r1, Rot r2) { return 2. / Math.PI * Math.acos( dot(r1,r2) ); }
